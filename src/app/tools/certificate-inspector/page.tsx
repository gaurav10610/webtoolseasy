...
const meta = TOOL_META["certificate-inspector"];
...
export default function CertificateInspectorPage() {
  const pageUrl = "https://webtoolseasy.com/tools/certificate-inspector";
  return (
    <>
      <script
      ...
      <ToolLandingLayout
        meta={meta}
        toolSlot={<InlineTool toolType="pem-certificate" />}
      />
    </>
  );
}
