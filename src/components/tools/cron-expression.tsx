...
export default function CronExpression() {
  ...
  const downloadCronExpression = useCallback(() => {
    const cronInfo = `# Cron Expression Generated by WebToolsEasy
# Expression: ${cronValue}
# Human readable: Generated cron job
# Add this to your crontab or scheduler

${cronValue}
`;
    const blob = new Blob([cronInfo], { type: "text/plain" });
    ...
    toolState.actions.showMessage("Cron expression downloaded successfully!");
  }, [cronValue, toolState.actions]);
  ...
  const buttons = useMemo(
    () => [
      ...
      },
      {
        ...
        text: "Download Cron File",
        onClick: downloadCronExpression,
      },
    ],
    [copyCronExpression, downloadCronExpression]
  );
