!(function (e, t) {
  ...
  (() => {
    ...
    (e.g = (function () {
      ...
      (() => {
        ...
        if (!t && r && (r.currentScript && (t = r.currentScript.src), !t)) {
          ...
          if (s.length)
            for (var a = s.length - 1; a > -1 && !t; ) t = s[a--].src;
        }
        if (!t)
          throw new Error(
    ...
    class i {
      ...
      #o = () => {
        this.#e &&
          (this.#e.onmessage = ({ data: { id: e, type: r, data: s } }) => {
            switch (r) {
              case t.LOAD:
            ...
            delete this.#t[e], delete this.#r[e];
          });
      };
      #i = ({ type: e, data: t }, r = []) =>
        this.#e
          ? new Promise((a, o) => {
              const i = s();
              this.#e && this.#e.postMessage({ id: i, type: e, data: t }, r),
                (this.#t[i] = a),
                (this.#r[i] = o);
            })
          : Promise.reject(a);
      on(e, t) {
        'log' === e ? this.#s.push(t) : 'progress' === e && this.#a.push(t);
      }
      off(e, t) {
        'log' === e
          ? this.#s.filter(e => e !== t)
          : 'progress' === e && this.#a.filter(e => e !== t);
      }
      load = (r = {}) => (
        this.#e ||
          ((this.#e = new Worker(new URL(e.p + e.u(814), e.b), {
            type: void 0,
          })),
          this.#o()),
        this.#i({ type: t.LOAD, data: r })
      );
      exec = (e, r = -1) =>
        this.#i({ type: t.EXEC, data: { args: e, timeout: r } });
      terminate = () => {
        const e = Object.keys(this.#r);
        for (const t of e) this.#r[t](o), delete this.#r[t], delete this.#t[t];
        this.#e && (this.#e.terminate(), (this.#e = null), (this.loaded = !1));
      };
      writeFile = (e, r) => {
        const s = [];
        return (
          r instanceof Uint8Array && s.push(r.buffer),
          this.#i({ type: t.WRITE_FILE, data: { path: e, data: r } }, s)
        );
      };
      readFile = (e, r = 'binary') =>
        this.#i({ type: t.READ_FILE, data: { path: e, encoding: r } });
      deleteFile = e => this.#i({ type: t.DELETE_FILE, data: { path: e } });
      rename = (e, r) =>
        this.#i({ type: t.RENAME, data: { oldPath: e, newPath: r } });
