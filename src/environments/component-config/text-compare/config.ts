...
export const descriptionData: DescriptionBlock[] = [
  ...
  },
  {
    ...
    listData: [
      `Text file comparsion is 100% free`,
      `Text file comparison is 100% secure as whole processing is being done at client side only (in host browser)`,
  ...
  {
    heading: 'What is the need of a text file comparison tool?',
    blockData: [
      `An online text file comparison tool is an essential tool for writers, students, researchers, and anyone who needs to compare texts quickly and easily. With this tool, you can compare different versions of a text, identify similarities and differences between texts, and highlight changes between texts.`,
