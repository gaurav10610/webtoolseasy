...
export const apps: Record<ApplicationIds, AppNavigationConfig> = {
  ...
  "meme-generator": {
    applicationId: "meme-generator",
    displayText: "Meme Generator Free",
    navigateUrl: "tools/meme-generator",
    iconRelativeUrl: "meme-icon.svg",
    category: AppCategory.MEDIA,
  },
  "meta-tag-generator": {
    applicationId: "meta-tag-generator",
    displayText: "Meta Tag Generator",
    navigateUrl: "tools/meta-tag-generator",
    iconRelativeUrl: "seo-icon.svg",
    category: AppCategory.SEO,
  },
  "robots-txt-generator": {
    applicationId: "robots-txt-generator",
    displayText: "Robots.txt Generator",
    navigateUrl: "tools/robots-txt-generator",
    iconRelativeUrl: "robot-icon.svg",
    category: AppCategory.SEO,
  },
  "diff-checker": {
    applicationId: "diff-checker",
    displayText: "Diff Checker Tool",
    navigateUrl: "tools/diff-checker",
    iconRelativeUrl: "comparison.svg",
    category: AppCategory.PROGRAMMING,
  },
  stopwatch: {
    applicationId: "stopwatch",
    displayText: "Stopwatch Online",
    navigateUrl: "tools/stopwatch",
    iconRelativeUrl: "stopwatch-icon.svg",
    category: AppCategory.MISCELLANEOUS,
  },
  "countdown-timer": {
    applicationId: "countdown-timer",
    displayText: "Countdown Timer Online",
    navigateUrl: "tools/countdown-timer",
